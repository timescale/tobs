...
func testRetentionSetDefault(t testing.TB, period int) {
    ...
    fmt.Printf("Running 'ts-obs metrics retention set-default %d'\n", period)
    set = exec.Command("/home/archen/go/bin/ts-obs", "metrics", "retention", "set-default", strconv.Itoa(period))
...
func testRetentionSet(t testing.TB, metric string, period int) {
    ...
    fmt.Printf("Running 'ts-obs metrics retention set %v %d'\n", metric, period)
    set = exec.Command("/home/archen/go/bin/ts-obs", "metrics", "retention", "set", metric, strconv.Itoa(period))
...
func testRetentionReset(t testing.TB, metric string) {
    ...
    fmt.Printf("Running 'ts-obs metrics retention reset %v'\n", metric)
    reset = exec.Command("/home/archen/go/bin/ts-obs", "metrics", "retention", "reset", metric)
...
func testChunkIntervalSetDefault(t testing.TB, interval string) {
    ...
    fmt.Printf("Running 'ts-obs metrics chunk-interval set-default %v'\n", interval)
    set = exec.Command("/home/archen/go/bin/ts-obs", "metrics", "chunk-interval", "set-default", interval)
...
func testChunkIntervalSet(t testing.TB, metric, interval string) {
    ...
    fmt.Printf("Running 'ts-obs metrics chunk-interval set %v %v'\n", metric, interval)
    set = exec.Command("/home/archen/go/bin/ts-obs", "metrics", "chunk-interval", "set", metric, interval)
...
func testChunkIntervalReset(t testing.TB, metric string) {
    ...
    fmt.Printf("Running 'ts-obs metrics chunk-interval reset %v'\n", metric)
    reset = exec.Command("/home/archen/go/bin/ts-obs", "metrics", "chunk-interval", "reset", metric)
